...
<meta charset="UTF-8">
<title>Faça o login agora e desfrute da sua própria videoteca </title>
		...
		<div class="content1">
			...
			<div id="registo">
				<form method="post" action = "logindb.jsp">
					...
					<p>
						<input type="submit" value="Login" name="submeter" onclick = "validalogin()"/>
					</p>
					...
					<p class="link">
						...
						&ensp; 
						&ensp; 
						Ainda não tem conta? <a href="registo.jsp"> Registe-se!
						</a>
					</p>
