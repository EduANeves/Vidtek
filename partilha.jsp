...
<meta charset="UTF-8">
<title>Partilha de videos</title>
...
<body scroll = "no">
	...
	string1 = "partilhar_videodb.jsp?parametro=" + user + "&video=" + id + "&tipo=" + tipo + "";
	string2 = "principal.jsp?parametro=" + user + "";
	String select ="SELECT nome FROM videopessoal WHERE id_videopessoal = '" + id + "' ";
	ResultSet rs;
		...
		<div class="content1">
			...
			<div id="registo">
				<form method="post" action =<%= string1 %>>
					...
					<p>
						<label>Nome do vídeo:</label> <input id="nome_vid" name="vid_nome" required="required" value="<%=nome %>" type="text" readonly="readonly" />
					</p>

					<p>
						<label>Username:</label><input id="usern" name="usern" type="text"  />
					</p>
					<p>
						<input type="submit" value="Compartilhar" name="submeter" onclick = "validalogin()"/>
					</p>	
					<p class="link">
