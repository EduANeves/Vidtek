...
<body scroll = "no">
	...
	if(at == 1){
	string1 = "adicionar_generodb.jsp?parametro=" + user + "&video=" + id + "&ativo=" + at + "";
	string2 = "cancelar.jsp?parametro=" + user + "&video=" + id + "&ativo=" + at + "";
	string3 = "adicionar_video.jsp?parametro=" + user + "&ativo=" + at + "";
	}
	if (at == 2){
		string1 = "adicionar_generodb.jsp?parametro=" + user + "&video=" + id + "&ativo=" + at + "";
		string2 = "cancelar.jsp?parametro=" + user + "&video=" + id + "&ativo=" + at + "";
	...
	<div class="container"><br><br><br><br><br><br>
		<div class="content1">
			...
			<div id="registo">
				...
				<h1>Insira o género</h1>

					<p>
						<label>Nome do género</label> 
					<select name="genero">
    						...
    						String select ="SELECT * FROM genero";
    						ResultSet rs;
					...
					<p><label> Caso não tenha mais géneros conclua a inserção</label> </p>
					<p>
						<input type="submit" value="Inserir" name="submeter" />
					</p>	
					<p class="link">
					<a href=<%= string2 %>>Cancelar</a> 
						&ensp; &ensp; 
						&ensp;&ensp; &ensp; 
						&ensp;&ensp;&ensp;
							&ensp; &ensp; 
