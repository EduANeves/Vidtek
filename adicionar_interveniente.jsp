...
<body scroll = "no">
	...
	String string5 ="adicionar_intervenientedb.jsp?parametro=" + user + "&video=" + id + "&ativo=" + at + "";
		if(at == 1){
	
	 		string2 = "cancelar.jsp?parametro=" + user + "&video=" + id + "&ativo=" + at + "";
			string3 = "adicionar_genero.jsp?parametro=" + user + "&video=" + id + "&ativo=" + at + "";
		}
		if(at == 2){
	...
	<div class="container"><br><br><br><br><br><br>
		<div class="content1">
			<br>
			<div id="registo">
				<form method="post" action =<%= string5 %>>
				<h1>Insira o Interveniente</h1>
					...
					&ensp; &ensp; 
						&ensp;&ensp; &ensp; 
						&ensp;&ensp;&ensp;
					Insira o <a href=<%= string3 %>> Género do filme
						</a>
						</p>
